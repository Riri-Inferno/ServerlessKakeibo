...
public class DeleteItemCategoryInteractor : IDeleteItemCategoryUseCase
{
    ...
    private readonly ILogger<DeleteItemCategoryInteractor> _logger;

    public DeleteItemCategoryInteractor(
        ...
        ILogger<DeleteItemCategoryInteractor> logger)
    {
    ...
    {
        _logger.LogInformation("商品カテゴリ削除を開始します。UserId: {UserId}, CategoryId: {CategoryId}", userId, categoryId);
        ...
        return await _transactionHelper.ExecuteInTransactionAsync(async () =>
        {
            ...
            _logger.LogInformation("商品カテゴリを非表示にしました。CategoryId: {CategoryId}", categoryId);
