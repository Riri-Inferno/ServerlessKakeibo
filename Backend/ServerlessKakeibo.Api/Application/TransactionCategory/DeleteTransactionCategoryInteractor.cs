...
/// <summary>
/// 取引カテゴリ削除（非表示化）インタラクター
/// </summary>
public class DeleteTransactionCategoryInteractor : IDeleteTransactionCategoryUseCase
{
    ...
    private readonly ILogger<DeleteTransactionCategoryInteractor> _logger;

    public DeleteTransactionCategoryInteractor(
        ...
        ILogger<DeleteTransactionCategoryInteractor> logger)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        _logger.LogInformation(
            "取引カテゴリ削除を開始します。UserId: {UserId}, CategoryId: {CategoryId}",
            userId, categoryId);
        ...
        return await _transactionHelper.ExecuteInTransactionAsync(async () =>
        {
            ...
            _logger.LogInformation(
                "取引カテゴリを非表示にしました。CategoryId: {CategoryId}",
                categoryId);
